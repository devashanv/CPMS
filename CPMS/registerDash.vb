...
Public Class frmRegiDash
    ...
    Private Sub frmRegiDash_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub txtRgMOH_TextChanged(sender As Object, e As EventArgs) Handles txtRgMOH.TextChanged
        btnDashRegi.Enabled = True
    End Sub

    Private Sub btnDashRegi_Click(sender As Object, e As EventArgs) Handles btnDashRegi.Click
